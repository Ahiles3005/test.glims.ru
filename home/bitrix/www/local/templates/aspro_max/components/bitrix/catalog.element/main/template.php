<? if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die(); 1?>
                        ...
                        <td>
                            <? if ('L' == $arResult['PROPERTIES'][$propID]['PROPERTY_TYPE'] && 'C' == $arResult['PROPERTIES'][$propID]['LIST_TYPE']) {
                                foreach ($propInfo['VALUES'] as $valueID => $value) {
                                    ?>
                                    <label>ordered-block js-store-scroll tabs-block
                                        <input type="radio"
        ...
        <div class="list-offers ajax_load">
            ...
            <div class="table-view flexbox flexbox--row">
                <? foreach ($arResult["OFFERS"] as $key => $arSKU): ?>
                    ...
                    ?>
                    <div
                        class="table-view__item item bordered box-shadow main_item_wrapper <?= ($useStores ? "table-view__item--has-stores" : ""); ?>">
                                            ...
                                            <? foreach ($arResult["SKU_PROPERTIES"] as $key => $arProp) { ?>
                                                <? if (!$arProp["IS_EMPTY"] && $key != 'ARTICLE'): ?>
                                                    ...
                                                    <div class="properties__item properties__item--compact ">
                                                        <div
                                                            class="properties__title muted properties__item--inline char_name font_sxs">
                                                        ...
                                                        <div
                                                            class="properties__value darken properties__item--inline char_value font_xs">
                            ...
                            <div class="item-actions flexbox flexbox--row">
                                ...
                                <div class="item-buttons item_<?= $arSKU["ID"] ?>">
                                    <div class="counter_wrapp list clearfix n-mb small-block">
                                        ...
                                        <? endif; ?>
                                        <div
                                            class="button_block <?= (in_array($arSKU["ID"], $arParams["BASKET_ITEMS"]) || $arskuAddToBasketData["ACTION"] == "ORDER" || ($arskuAddToBasketData["ACTION"] == 'MORE' || !$arskuAddToBasketData["CAN_BUY"]) || !$arskuAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] ? "wide" : ""); ?>">
                                            <!--noindex-->
                            ...
                            <? if ($useStores): ?>
                                <div class="stores-icons">
                                    <div class="like_icons list static icons">
                                        <div>
                                            <span
                                                class="btn btn_xs btn-transparent"><?= CMax::showIconSvg("cat_icons", SITE_TEMPLATE_PATH . "/images/svg/catalog/arrow_sku.svg", "", "", true, false); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <? endif; ?>
...
<? //top info?>
<div class="product-info <?= (!$showCustomOffer ? "noffer" : ""); ?> bordered rounded3"
     id="<?= $arItemIDs["strMainID"]; ?>">
    <script
        type="text/javascript">setViewedProduct(<?=$arResult['ID']?>, <?=CUtil::PhpToJSObject($arViewedData, false)?>);</script>
                                    ...
                                    <div class="blog-info__rating--top-info pointer">
                                        <div class="votes_block nstar with-text" itemprop="aggregateRating" itemscope
                                            ...
                                            <meta itemprop="ratingValue"
                                                  content="<?= ($arResult['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] ? $arResult['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] : 5) ?>"/>
                                            <meta itemprop="reviewCount"
                                                  content="<?= (intval($arResult['PROPERTIES']['EXTENDED_REVIEWS_COUNT']['VALUE']) ? intval($arResult['PROPERTIES']['EXTENDED_REVIEWS_COUNT']['VALUE']) : 1) ?>"/>
                                            ...
                                            <div class="ratings">
                                                ...
                                                <div class="inner_rating" title="<?= $message ?>">
                                                    <? for ($i = 1; $i <= 5; $i++):?>
                                                        <div
                                                            class="item-rating <?= $i <= $arResult['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] ? 'filed' : '' ?>"><?= CMax::showIconSvg("star", SITE_TEMPLATE_PATH . "/images/svg/catalog/star_small.svg"); ?></div>
                                                    <? endfor; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <? if ($arResult['PROPERTIES']['EXTENDED_REVIEWS_COUNT']['VALUE']):?>
                                            <span
                                                class="font_sxs"><?= $arResult['PROPERTIES']['EXTENDED_REVIEWS_COUNT']['VALUE'] ?></span>
                                        <? endif; ?>
                                    </div>
                                <? else:?>
                        ...
                        <div class="product-info-headnote__article">
                            <div class="article muted font_xs" itemprop="additionalProperty" itemscope
                                ...
                                <span class="article__title"
                                      itemprop="name"><?= $arResult["CML2_ARTICLE"]["NAME"]; ?>:</span>
                                <span class="article__value"
                                      itemprop="value"><?= $arResult["CML2_ARTICLE"]["VALUE"] ?></span>
                            </div>
                        </div>
                    <? endif; ?>
                </div>
    ...
    <div class="product-detail-gallery swipeignore left_info">
        <div
            class="product-detail-gallery__container<?= ($bVertical ? ' product-detail-gallery__container--vertical' : ''); ?>">
            ...
            <link href="<?= ($arFirstPhoto["BIG"]["src"] ? $arFirstPhoto["BIG"]["src"] : $arFirstPhoto["SRC"]); ?>"
                  itemprop="image"/>
            <div
                class="product-detail-gallery__slider<? if (!$bMagnifier): ?> owl-carousel owl-theme big owl-bg-nav short-nav<? else: ?> hidden-xs<? endif; ?> <?= $arParams['PICTURE_RATIO']; ?>"
                ...
                <? if ($showCustomOffer && !empty($arResult['OFFERS_PROP'])) { ?>
                    ...
                    <div id="photo-sku"
                        ...
                        <? if ($arFirstPhoto["BIG"]["src"]): ?>
                            <a href="<?= ($viewImgType == "POPUP" ? $arFirstPhoto["BIG"]["src"] : "javascript:void(0)"); ?>" <?= ($bIsOneImage ? '' : 'data-fancybox="gallery"') ?>
                               class="product-detail-gallery__link <?= ($viewImgType == "POPUP" ? "popup_link fancy" : "line_link fancy_zoom"); ?>"
                               title="<?= $title; ?>">
                                <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                     class="lazy product-detail-gallery__picture <?= ($viewImgType == "MAGNIFIER" ? "zoom_picture" : ""); ?>"
                                     data-src="<?= ($arFirstPhoto["SMALL"]["src"] ? $arFirstPhoto["SMALL"]["src"] : $arFirstPhoto["SRC"]) ?>"
                                     src="<?= \Aspro\Functions\CAsproMax::showBlankImg(($arFirstPhoto["SMALL"]["src"] ? $arFirstPhoto["SMALL"]["src"] : $arFirstPhoto["SRC"])) ?>" <?= ($viewImgType == "MAGNIFIER" ? 'data-xoriginal="' . $arFirstPhoto["BIG"]["src"] . '" data-xpreview="' . $arFirstPhoto["THUMB"]["src"] . '"' : ""); ?>
                                     alt="<?= $alt; ?>" title="<?= $title; ?>"/>
                            </a>
                        <? else: ?>
                            <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                 class="lazy product-detail-gallery__picture one"
                                 data-src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arFirstPhoto["SRC"]) ?>"
                    ...
                    if ($arResult["MORE_PHOTO"]) {
                        ...
                        foreach ($arResult["MORE_PHOTO"] as $i => $arImage) {
                            ...
                            <div id="photo-<?= $i ?>"
                                ...
                                if (!$isEmpty) {
                                    ?>
                                    <a href="<?= ($viewImgType == "POPUP" ? $arImage["BIG"]["src"] : "javascript:void(0)"); ?>" <?= ($bIsOneImage ? '' : 'data-fancybox="gallery"') ?>
                                       class="product-detail-gallery__link <?= ($viewImgType == "POPUP" ? "popup_link fancy" : "line_link fancy_zoom"); ?>"
                                       title="<?= $title; ?>">
                                        <img
                                            class="lazy product-detail-gallery__picture <?= ($viewImgType == "MAGNIFIER" ? "zoom_picture" : ""); ?>"
                                            data-src="<?= $arImage["SMALL"]["src"] ?>"
                                            src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arImage["SMALL"]["src"]) ?>" <?= ($viewImgType == "MAGNIFIER" ? 'data-xoriginal="' . $arImage["BIG"]["src"] . '" data-xpreview="' . $arImage["THUMB"]["src"] . '"' : ""); ?>
                                            alt="<?= $alt; ?>"
                                ...
                                <?
                                    ...
                                    <img class="lazy product-detail-gallery__picture one"
                                         src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arImage["SRC"]) ?>"
                                         data-src="<?= $arImage["SRC"] ?>" alt="<?= $alt; ?>" title="<?= $title; ?>"/>
                                <?
                                } ?>
                            </div>
                        <?
            ...
            <? if ($bMagnifier): ?>
                <div
                    class="product-detail-gallery__slider owl-carousel owl-theme big visible-xs <?= $arParams['PICTURE_RATIO']; ?>"
                    ...
                    <? if ($showCustomOffer && !empty($arResult['OFFERS_PROP'])) { ?>
                        ...
                        <div id="photo-sku"
                             class="product-detail-gallery__item product-detail-gallery__item--big text-center">
                            <? if ($arFirstPhoto["BIG"]["src"]): ?>
                                <a href="<?= $arFirstPhoto["BIG"]["src"]; ?>" data-fancybox="gallery"
                                   class="product-detail-gallery__link popup_link fancy" title="<?= $title; ?>">
                                    <img id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PICT']; ?>"
                                         class="lazy product-detail-gallery__picture"
                                         data-src="<?= $arFirstPhoto["SMALL"]["src"] ?>"
                                         src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arFirstPhoto["SMALL"]["src"]) ?>"
                                         alt="<?= $alt; ?>"
                                         title="<?= $title; ?>"<? //=(!$i ? ' itemprop="image"' : '')?>/>
                                </a>
                            <? else: ?>
                        ...
                        if ($arResult["MORE_PHOTO"]) {
                            ...
                            foreach ($arResult["MORE_PHOTO"] as $i => $arImage) {
                                ...
                                <div id="photo-<?= $i ?>"
                                    ...
                                    if (!$isEmpty) {
                                        ?>
                                        <a href="<?= $arImage["BIG"]["src"]; ?>" data-fancybox="gallery"
                                           class="product-detail-gallery__link popup_link fancy" title="<?= $title; ?>">
                                    ...
                                    <?
                                        ...
                                        ?>
                                        <img class="lazy product-detail-gallery__picture"
                                             data-src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arImage["SRC"]) ?>"
                                             src="<?= $arImage["SRC"] ?>" alt="<?= $alt; ?>" title="<?= $title; ?>"/>
                                    <?
                                    } ?>
                                </div>
                            <?
            ...
            <div class="product-detail-gallery__thmb-container text-center">
                <div class="product-detail-gallery__thmb-inner">
                    <? if (!$showCustomOffer || empty($arResult['OFFERS_PROP'])): ?>
                        <? if ($countPhoto > 1): ?>
                            <div
                                class="product-detail-gallery__slider owl-carousel owl-theme thmb<?= ($bVertical ? ' product-detail-gallery__slider--vertical' : ''); ?>"
                                data-size="<?= $countPhoto; ?>"
                                data-plugin-options='{"items": "4", "nav": true, "loop": false, "clickTo": ".product-detail-gallery__slider.big", "dots": false, "autoWidth": true, "margin": 10<? //if($bVertical):?>, "mouseDrag": false, "pullDrag": false<? //endif;?><? if ($bMagnifier): ?>, "magnifier": true<? endif; ?>}'
                                style="max-width:<?= ceil((($countPhoto <= 4 ? $countPhoto : 4) * 70) - 10) ?>px;">
                                <? if ($arResult["MORE_PHOTO"]): ?>
                                    <? foreach ($arResult["MORE_PHOTO"] as $i => $arImage): ?>
                                        <div id="photo-<?= $i ?>"
                                             class="product-detail-gallery__item text-center  product-detail-gallery__item--thmb"
                                             data-big="<?= $arImage["BIG"]["src"]; ?>">
                                            <? if (!$isEmpty) { ?>
                                                <img class="lazy product-detail-gallery__picture"
                                                     data-src="<?= $arImage["SMALL"]["src"] ?>"
                                                     src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arImage["SMALL"]["src"]) ?>"
                        ...
                        <? if ($arResult['PROPERTIES']['POPUP_VIDEO']['VALUE']): ?>
                            <div class="video-block popup_video <?= ($countPhoto > 4 ? 'fromtop' : ''); ?> sm"><a
                                    class="various video_link image dark_link"
                                    href="<?= $arResult['PROPERTIES']['POPUP_VIDEO']['VALUE']; ?>"
                                    title="<?= Loc::getMessage("VIDEO") ?>"><span
                                        class="play text-upper font_xs"><?= Loc::getMessage("VIDEO") ?></span></a></div>
                        <? endif; ?>
                    <? else: ?>
                        <div
                            class="product-detail-gallery__slider owl-carousel owl-theme thmb<?= ($bVertical ? ' product-detail-gallery__slider--vertical' : ''); ?>"
    ...
    <div class="right_info">
        <div class="info_item hidden-md hidden-lg">
            ...
            <? if (($arResult['DISPLAY_PROPERTIES'] || $arResult['DISPLAY_PROPERTIES_OFFERS']) && $arParams['VISIBLE_PROP_COUNT'] > 0): ?>
                <div class="char-side">
                    <div
                        class="char-side__title font_sm darken"><?= ($arParams["T_CHARACTERISTICS"] ? $arParams["T_CHARACTERISTICS"] : Loc::getMessage("T_CHARACTERISTICS")); ?></div>
                    <div class="properties list">
                    ...
                    <? if ($bShowMoreLink): ?>
                        <div class="more-char-link"><span class="choise colored_theme_text_with_hover font_sxs dotted"
                                                          data-block=".js-scrolled"><?= Loc::getMessage('ALL_CHARS'); ?></span>
                        </div>
                    <? endif; ?>
                </div>
            <? endif; ?>
                    ...
                    <div class="price_txt muted777 font_sxs ">
                        ...
                        <div class="text-form-info">
                            <span><span class="animate-load dotted" data-event="jqm" data-param-form_id="SEND_GIFT"
                                        data-name="send_gift"
                                        data-autoload-product_name="<?= CMax::formatJsName($arResult["NAME"]); ?>"
                                        data-autoload-product_link="<?= $sCurrentPage; ?>"
                                        data-autoload-product_id="<?= $arResult["ID"]; ?>"><?= ($arParams["SEND_GIFT_FORM_NAME"] ? $arParams["SEND_GIFT_FORM_NAME"] : GetMessage("SEND_GIFT_FORM")); ?></span></span>
                        </div>
                    </div>
                </div>
            <? endif; ?>
            ...
            <div class="main_item_wrapper js-offers-calc product-action">
                            ...
                            <? if ($arParams["SHOW_CHEAPER_FORM"] == "Y"): ?>
                                <div class="cheaper_form muted777 font_xs">
                                    ...
                                    <span class="animate-load dotted" data-event="jqm" data-param-form_id="CHEAPER"
                                          data-name="cheaper"
                                          data-autoload-product_name="<?= CMax::formatJsName($arResult["NAME"]); ?>"
                                          data-autoload-product_id="<?= $arResult["ID"]; ?>"><?= ($arParams["CHEAPER_FORM_NAME"] ? $arParams["CHEAPER_FORM_NAME"] : Loc::getMessage("CHEAPER")); ?></span>
                                </div>
                            <? endif; ?>
                        </div>
                ...
                <? if (!$bComplect): ?>
                    ...
                    <div class="js-prices-in-side product-action">
                        <div class="buy_block">
							<?if(!empty($arResult['PROPERTIES']['PRODUCT_VARIANTS']['ITEMS']) && !empty($arResult['PROPERTIES']['PROP_159']['VALUE'][0])){?>
							
							<div  class="sku_props  111">
								<div  class="bx_catalog_item_scu wrapper_sku" id="bx_117848907_266_skudiv">
									<div class="bx_item_detail_size" style=""  data-display_type="LI"  >
										<span class="show_class bx_item_section_name"><span>Вес, кг<span class="sku_mdash">—</span></span><span class="val"><?=$arResult['PROPERTIES']['PROP_159']['VALUE'][0]?></span></span>
										<div class="bx_size_scroller_container scrollblock scrollblock--ob-auto">
											<div class="bx_size">
												<ul   class="list_values_wrapper">
													<?foreach($arResult['PROPERTIES']['PRODUCT_VARIANTS']['ITEMS'] as $item_ofer){?>
														
														<li class="list_values_wrapper__link <?if($item_ofer['PROPERTY_168_VALUE'] == $arResult['PROPERTIES']['PROP_159']['VALUE'][0]){echo 'active';}?>" style=""  data-showtype="li"   title="Вес, кг: <?=$item_ofer['PROPERTY_168_VALUE']?>"><i></i>
                                                            <a href='<?=$item_ofer['DETAIL_PAGE_URL']?>' class="cnt"><?=$item_ofer['PROPERTY_168_VALUE']?></a>
                                                        </li>
													<?}?>   
												</ul>
											</div>
							...
							<?}elseif ($arResult["OFFERS"] && $showCustomOffer){ ?>
                                <div class="sku_props  111">
                            ...
                            <? elseif ($arResult["OFFERS"] && $arParams['TYPE_SKU'] != 'TYPE_1'): ?>
                                <span
                                    class="btn btn-default btn-lg slide_offer type_block"><i></i><span><?= \Bitrix\Main\Config\Option::get("aspro.max", "EXPRESSION_READ_MORE_OFFERS_DEFAULT", GetMessage("MORE_TEXT_BOTTOM")); ?></span></span>
                            <? endif; ?>
                        </div>
                    </div>
                    <? $this->EndViewTarget(); ?>
                ...
                <div class="adaptive-block">
                    ...
                    <div class="" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                        ...
                        <link itemprop="availability"
                              href="http://schema.org/<?= ($templateData['TOTAL_COUNT'] ? 'InStock' : 'OutOfStock') ?>"/>
                        <?
                ...
                <div class="brand-detail">
                    <div class="brand-detail-info bordered rounded3">
                        <? if ($arResult['BRAND_ITEM']["IMAGE"]): ?>
                            <div class="brand-detail-info__image"><a
                                    href="<?= $arResult['BRAND_ITEM']["DETAIL_PAGE_URL"]; ?>"><img
                                        ...
                                        title="<?= $arResult['BRAND_ITEM']["NAME"]; ?>" itemprop="image"></a></div>
                        <? endif; ?>
                        <div class="brand-detail-info__preview">
                            ...
                            <? endif; ?>
                            <? if ($arResult['SECTION']): ?>
                                <div class="link font_xs"><a href="<?= $arResult['BRAND_ITEM']['CATALOG_PAGE_URL'] ?>"
                                                             target="_blank"><?= GetMessage("ITEMS_BY_SECTION") ?></a>
                                </div>
                            <? endif; ?>
                            <div class="link font_xs"><a href="<?= $arResult['BRAND_ITEM']["DETAIL_PAGE_URL"]; ?>"
...
<?php if ($arResult["PROPERTIES"]["ADVANTAGES"]["VALUE"]!==false): ?>
    <h3>Почему <?= $arResult["NAME"] ?>?</h3>
    <div class="advantage-block">
        <?php foreach ($arResult["PROPERTIES"]["ADVANTAGES"]["VALUE"] as $advantage_key => $advantage_image_id): ?>
            <div class="advantage-item">
                <?php
                $advantage_src = CFile::ResizeImageGet($advantage_image_id, array('width' => 50, 'height' => 50), BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true)["src"];
                ?>
                <img src="<?= $advantage_src ?>">
                <div class="advantage-description">
                    <?= $arResult["PROPERTIES"]["ADVANTAGES"]["DESCRIPTION"][$advantage_key] ?>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
<?php endif; ?>
<?php
//var_dump($arResult["PROPERTIES"]["ADVANTAGES"]["DESCRIPTION"]);
?>
...
<? if ($arResult['ADDITIONAL_GALLERY']): ?>
    ...
    <div class="ordered-block">
        <div
            class="additional-gallery <?= ($arResult['OFFERS'] && 'TYPE_1' === $arParams['TYPE_SKU'] ? ' hidden' : '') ?>">
            ...
            <div class="switch-item-block">
                <div class="flexbox flexbox--row">
                    <div class="switch-item-block__count muted777 font_xs">
                        <div
                            class="switch-item-block__count-wrapper switch-item-block__count-wrapper--small" <?= ($bShowSmallGallery ? "" : "style='display:none;'"); ?>>
                            <span
                                class="switch-item-block__count-value"><?= count($arResult['ADDITIONAL_GALLERY']); ?></span>
                            <?= Loc::getMessage('PHOTO'); ?>
                            <span class="switch-item-block__count-separate">&mdash;</span>
                        </div>
                        <div
                            class="switch-item-block__count-wrapper switch-item-block__count-wrapper--big" <?= ($bShowSmallGallery ? "style='display:none;'" : ""); ?>>
                            <span
                                class="switch-item-block__count-value">1/<?= count($arResult['ADDITIONAL_GALLERY']); ?></span>
                            <span class="switch-item-block__count-separate">&mdash;</span>
                        </div>
                    </div>
                    <div class="switch-item-block__icons-wrapper">
                        <span
                            class="switch-item-block__icons<?= (!$bShowSmallGallery ? ' active' : ''); ?> switch-item-block__icons--big"
                        ...
                        <span
                            class="switch-item-block__icons<?= ($bShowSmallGallery ? ' active' : ''); ?> switch-item-block__icons--small"
                ...
                <div class="row flexbox flexbox--row">
                    <? foreach ($arResult['ADDITIONAL_GALLERY'] as $i => $arPhoto): ?>
                        <div class="col-md-3 col-sm-4 col-xs-6">
                            <div class="item">
                                <div class="wrap"><a href="<?= $arPhoto['DETAIL']['SRC'] ?>" class="fancy"
                                                     data-fancybox="small-gallery" target="_blank"
                                                     title="<?= $arPhoto['TITLE'] ?>">
                                        <img data-src="<?= $arPhoto['PREVIEW']['src'] ?>"
                                             src="<?= \Aspro\Functions\CAsproMax::showBlankImg($arPhoto['PREVIEW']['src']); ?>"
                                             class="lazy img-responsive inline" title="<?= $arPhoto['TITLE'] ?>"
                                             alt="<?= $arPhoto['ALT'] ?>"/></a>
                                </div>
                            </div>
                        </div>
...
<? if (($arResult['DISPLAY_PROPERTIES'] || $arResult['DISPLAY_PROPERTIES_OFFERS']) && ($iCountProps > $arParams['VISIBLE_PROP_COUNT'])): ?>
    ...
    <? else: ?>
        <? if ($arParams["PROPERTIES_DISPLAY_TYPE"] != "TABLE"): ?>
            <div class="props_block js-scrolled clearfix flexbox row"
                 id="<? echo $arItemIDs["ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>">
                <? foreach ($arResult["DISPLAY_PROPERTIES"] as $propCode => $arProp): ?>
                    <div class="char col-lg-3 col-md-4 col-xs-6 bordered" itemprop="additionalProperty" itemscope
                         itemtype="http://schema.org/PropertyValue">
                        <div class="char_name">
                            <div
                                class="props_item muted <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>whint<? } ?>">
                ...
                <table class="props_list nbg">
                    <? foreach ($arResult["DISPLAY_PROPERTIES"] as $arProp): ?>
                        <tr itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                            <td class="char_name">
                                <div
                                    class="props_item <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y") { ?>whint<? } ?>">
                                    <span itemprop="name"><?= $arProp["NAME"] ?></span>
                                    <? if ($arProp["HINT"] && $arParams["SHOW_HINTS"] == "Y"): ?>
                                        <div class="hint"><span class="icon"><i>?</i></span>
                                        <div class="tooltip"><?= $arProp["HINT"] ?></div></div><? endif; ?>
