...
<?php
$market_ID = $ElementID;
$market_IBLOCK_ID = $arParams['IBLOCK_ID'];
if(isset($_REQUEST["oid"])){
$market_ID = intval($_REQUEST["oid"]);
$market_IBLOCK_ID = 20;
}
$_SESSION['MARKETPLACE_ELEMENT_ID'] = $market_ID;
$_SESSION['MARKETPLACE_IBLOCK_ID'] = $market_IBLOCK_ID;
 ?>
<div class="marketplace" id="marketplace">
<?include_once($_SERVER["DOCUMENT_ROOT"].'/include/marketplace.php');?>
	</div>
	<?//bigdata?>
