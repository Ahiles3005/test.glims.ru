...
class CNextEvents{
	...
	static function onBeforeResultAddHandler($WEB_FORM_ID, &$arFields, &$arrVALUES){
		if(!defined('ADMIN_SECTION'))
		{
            ...
            $id = CForm::GetBySID('ZAKAZ_GLIMS_FORM')->Fetch()['ID'];
            $idEnForm = CForm::GetBySID('ZAKAZ_GLIMS_FORM_EN')->Fetch()['ID'];
            ...
            if($id !== $WEB_FORM_ID && $idEnForm !== $WEB_FORM_ID && $arTheme['SHOW_LICENCE'] == 'Y' && ((!isset($arrVALUES['licenses_popup']) || !$arrVALUES['licenses_popup']) && (!isset($arrVALUES['licenses_inline']) || !$arrVALUES['licenses_inline'])))
